...
I would like to evaluate a Vision Transformer encoder paired with a metric-learning objective to flag off-distribution frames, comparing embedding drift over time against human-labeled incidents.
